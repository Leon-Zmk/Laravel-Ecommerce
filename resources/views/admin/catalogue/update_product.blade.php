                    ...
                    <div class="card-body">
                        <form action="{{route("productUpdate",$product->id)}}" method="POST" enctype="multipart/form-data">
                             ...
                             <div class="form-group">
                                ...
                                <select name="category_id" id="category_id" class=" custom-select">
                                  ...
                                  @foreach ($section->categories as $category)
                                      <option value="{{$category->id}}"  @if ($product->category_id == $category->id ) selected  @endif>&nbsp;&nbsp;&raquo;{{$category->name}}</option>

                                      @foreach ($category->subcategories as $scategory)
                                      <option value="{{$scategory->id}}"  @if ($product->category_id == $scategory->id ) selected  @endif>&nbsp;&nbsp;&nbsp;&nbsp;&raquo;{{$scategory->name}}</option>
                                      @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="color" value="{{$product->color}}" id="color" class="  form-control">
                                @error('color')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="discount" value="{{$product->discount}}" id="discount" class="  form-control">
                                @error('discount')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            @if($product->image=='product_default.png')
                               @else
                                <div class="form-group">
                                  <a href="{{asset("storage/frontend/products/large/".$product->image)}}">View Image</a>| <button class="border-0" form="productImage">Delete Image</button>
                                </div>
                            @endif
                        ...
                        <form action="{{route("deleteproductImage")}}" id="productImage" method="POST">
